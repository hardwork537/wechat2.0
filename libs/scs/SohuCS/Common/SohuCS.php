...
use SohuCS\Common\Facade\Facade;
 ...
 */
class SohuCS extends ServiceBuilder
{
    /**
    ...
    /**
     * Create a new service locator for the SCS SDK
     *
    ...
    public static function factory($config = null, array $globalParameters = array())
    {
        ...
        $loader->addAlias('_scs', self::getDefaultServiceDefinition())
    ...
    {
        return __DIR__  . '/Resources/scs-config.php';
    }
