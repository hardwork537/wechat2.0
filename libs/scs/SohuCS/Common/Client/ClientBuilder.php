...
use SohuCS\Common\Exception\ExceptionListener;
use SohuCS\Common\Exception\InvalidArgumentException;
use SohuCS\Common\Exception\NamespaceExceptionFactory;
use SohuCS\Common\Exception\Parser\DefaultXmlExceptionParser;
use SohuCS\Common\Exception\Parser\ExceptionParserInterface;
use SohuCS\Common\Iterator\SohuCSResourceIteratorFactory;
use SohuCS\Common\Signature\EndpointSignatureInterface;
use SohuCS\Common\Signature\SignatureInterface;
use SohuCS\Common\Signature\SignatureV2;
use SohuCS\Common\Signature\SignatureV3;
use SohuCS\Common\Signature\SignatureV3Https;
...
class ClientBuilder
{
     ...
     */
    protected static $commonConfigDefaults = array('scheme' => 'http');
    ...
    public function build()
    {
        ...
        $clientClass = 'SohuCS\Common\Client\DefaultClient';
        ...
        /** @var $client SohuCSClientInterface */
        ...
        $client->getConfig()->set(
            ...
            'header=date,x-scs-date,x-scs-security-token,x-scsn-authorization'
        );

        // Set the iterator resource factory based on the provided iterators config
        $client->setResourceIteratorFactory(new SohuCSResourceIteratorFactory(
    ...
    protected function updateConfigFromDescription(Collection $config)
    {
        ...
        } elseif ($global && (!$region || $description->getData('namespace') !== 'Scs')) {
            $region = Region::BJCNC;
     ...
     * version identifier string or an instance of SohuCS\Common\Signature\SignatureInterface.
     *
    ...
    protected function getSignature(ServiceDescription $description, Collection $config)
    {
        ...
        if (is_string($signature)) {
            ...
            throw new InvalidArgumentException('The provided signature is not '
                ...
                . 'SohuCS\\Common\\Signature\\SignatureInterface');
        }
