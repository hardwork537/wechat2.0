...
namespace SohuCS\Scs\Iterator;

use Guzzle\Service\Resource\Model;
use SohuCS\Common\Iterator\SohuCSResourceIterator;

/**
 * Iterator for the Scs ListMultipartUploads command
 *
 * This iterator includes the following additional options:
 *
 * - return_prefixes: Set to true to return both prefixes and uploads
 */
class ListMultipartUploadsIterator extends SohuCSResourceIterator
{
    /**
     * {@inheritdoc}
     */
