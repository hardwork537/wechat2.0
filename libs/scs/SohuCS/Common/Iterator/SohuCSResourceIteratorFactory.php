...
namespace SohuCS\Common\Iterator;
 ...
 */
class SohuCSResourceIteratorFactory implements ResourceIteratorFactoryInterface
{
    /**
    ...
    public function build(CommandInterface $command, array $options = array())
    {
        ...
        if ($this->primaryIteratorFactory && $this->primaryIteratorFactory->canBuild($command)) {
            ...
            $iterator = new SohuCSResourceIterator($command, $options);
        }
