<?php
	...
	class ManageController extends BaseController{
		...
		public function indexAction(){
            ...
            $arrLog['logType'] = RealtorLog::LOGTYPE_UPDOWN;
            ...
            //$strPublishStatus = 'offline';  //待确认

            $objhouse = new House();
            $objhousepic = new HousePicture();
            $mVipQue = new VipRefreshQueue();

            $intOnLineCount = 0;     //已发布
            $intOffLineCount = 0;    //待发布
            ...
            if($strUnitType == 'sale')
            {
                ...
                if($intOffLineCount > 0)
                {
                    ...
                    {
                        $imgcount = $objhousepic->getHousePicCountById($val['id'],HousePicture::STATUS_OK);
                ...
                $whereOnline ='House.type IN (20,21,22)   and House.realId = '.$aryBrokerInfo['id'];     //出售
            ...
            else
            {
                ...
                //已发布出租
                $columnsOnline ='House.id,House.bedRoom,House.livingRoom,House.bA,House.price,House.create,House.quality,House.timing,House.verification,House.xiajia,rent.title,rent.refreshTime,rent.parkName,House.type as houseType,rent.price as price';
                $whereOnline ='House.type IN (10,11)   and House.realId = '.$aryBrokerInfo['id'];
                $arrHouseOnline = $objhouse->getHouseByRealtorCondition($whereOnline,$columnsOnline,'House.id desc',0,500);
                $intOnLineCount = count($arrHouseOnline);
            }
            ...
            $this->assign(array(
                ...
                'leftOnLineNum'=>$intLeftOnLineNum,
                'reStr'=>$reStr
            ));
        ...
        public function offlinelistAction(){
            $this->display('manage','offlinelist');
        }
        ...
        public function onlinelistAction(){
            $this->display('manage','onlinelist');
        }
