...
use SohuCS\Common\Enum\DateFormat;
use SohuCS\Scs\ScsClient;
use Guzzle\Common\Collection;
use Guzzle\Http\Url;

/**
 * Encapsulates the logic for getting the data for an Scs object POST upload form
 */
class PostObject extends Collection
{
    /**
     * @var ScsClient The Scs client being used to sign the policy
     */
    protected $client;
     ...
     * - success_action_redirect:      The URI for Amazon Scs to redirect to upon successful upload
     * - success_action_status:        The status code for Amazon Scs to return upon successful upload
     ...
     * character
     *
     * @param ScsClient $client
     * @param $bucket
     * @param array $options
     */
    public function __construct(ScsClient $client, $bucket, array $options = array())
    {
    ...
    public function prepareData()
    {
        ...
        $policy = array(
            'expiration' => gmdate(DateFormat::ISO8601_Scs, $ttd),
