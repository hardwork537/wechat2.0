...
namespace SohuCS\Common\Facade;
...
abstract class Facade implements FacadeInterface
{
     ...
     *
     * @param SohuCS $serviceBuilder
     */
    public static function mountFacades(SohuCS $serviceBuilder, $targetNamespace = null)
    {
     ...
     *
     * @return \SohuCS\Common\Client\SohuCSClientInterface
     */
