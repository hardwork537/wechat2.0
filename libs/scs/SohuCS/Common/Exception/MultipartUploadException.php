...
use SohuCS\Common\Model\MultipartUpload\TransferStateInterface;

/**
 * Thrown when a {@see SohuCS\Common\MultipartUpload\TransferInterface} object encounters an error during transfer
 */
