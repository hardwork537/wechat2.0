...
class UploadSyncBuilder extends AbstractSyncBuilder
{
    ...
    /**
     * Set the path that contains files to recursively upload to Amazon Scs
     *
    ...
    /**
     * Set a glob expression that will match files to upload to Amazon Scs
     *
