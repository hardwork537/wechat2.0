...
namespace SohuCS\Scs\Sync;

use SohuCS\Common\Exception\RuntimeException;
use SohuCS\Common\Exception\UnexpectedValueException;
use SohuCS\Common\Model\MultipartUpload\TransferInterface;
use SohuCS\Scs\ScsClient;
use SohuCS\Scs\Iterator\OpendirIterator;
...
abstract class AbstractSyncBuilder
{
    ...
    /** @var ScsClient Amazon Scs client used to send requests */
    protected $client;
    ...
    /** @var string Prefix at prepend to each Amazon Scs object key */
    protected $keyPrefix = '';

    /** @var string Directory separator for Amazon Scs keys */
    protected $delimiter = '/';
     ...
     *
     * @param string $bucket Amazon Scs bucket name
     *
     * @return self
     */
    ...
    /**
     * Set the Amazon Scs client object that will send requests
     *
     * @param ScsClient $client Amazon Scs client
     *
     * @return self
     */
    public function setClient(ScsClient $client)
    {
        $this->client = $client;
    ...
    /**
     * Specify a prefix to prepend to each Amazon Scs object key or the prefix where object are stored in a bucket
     *
    ...
    /**
     * Create an Amazon Scs file iterator based on the given builder settings
     *
     * @return OpendirIterator
     */
    protected function createScsIterator()
    {
