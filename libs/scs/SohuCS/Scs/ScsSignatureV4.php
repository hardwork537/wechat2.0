...
/**
 * Amazon Scs signature version 4
 */
class ScsSignatureV4 extends SignatureV4 implements ScsSignatureInterface
{
    ...
    private function convertExpires($expires)
    {
        ...
        if ($duration > 604800) {
            throw new InvalidArgumentException('The expiration date of an '
                . 'Amazon Scs presigned URL using signature version 4 must be '
                . 'less than one week.');
        }
