...
namespace SohuCS\Common\Hash;

use SohuCS\Common\Enum\Size;
...
class TreeHash implements ChunkHashInterface
{
    ...
    public static function fromChecksums(array $checksums, $inBinaryForm = false, $algorithm = self::DEFAULT_ALGORITHM)
    {
        ...
        $treeHash->checksums = $inBinaryForm ? $checksums : array_map('SohuCS\Common\Hash\HashUtils::hexToBin', $checksums);
