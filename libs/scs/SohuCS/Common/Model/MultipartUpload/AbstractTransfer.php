...
namespace SohuCS\Common\Model\MultipartUpload;

use SohuCS\Common\Client\SohuCSClientInterface;
use SohuCS\Common\Exception\MultipartUploadException;
...
abstract class AbstractTransfer extends AbstractHasDispatcher implements TransferInterface
{
    ...
    /**
     * @var SohuCSClientInterface Client used for the transfers
     */
    protected $client;
     ...
     *
     * @param SohuCSClientInterface     $client  Client used for the transfers
