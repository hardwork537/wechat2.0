...
namespace SohuCS\Common\InstanceMetadata;

use SohuCS\Common\Enum\ClientOptions as Options;
use SohuCS\Common\Exception\InstanceProfileCredentialsException;
    ...
    public function getInstanceProfileCredentials()
    {
        try {
            ...
            $message = sprintf('Error retrieving credentials from the instance profile metadata server. When you are'
                ...
                . ' SohuCS\\Common\\Credentials\\CredentialsInterface object. (%s)', $e->getMessage());
