 ...
 * queue for deleting keys from an Amazon Scs bucket. You can add DeleteObject
...
class DeleteObjectsBatch extends AbstractBatchDecorator
{
     ...
     *
     * @param SohuCSClientInterface $client Client used to transfer requests
     * @param string             $bucket Bucket that contains the objects to delete
     * @param string             $mfa    MFA token to use with the request
     *
     * @return self
     */
    public static function factory(SohuCSClientInterface $client, $bucket, $mfa = null)
    {
