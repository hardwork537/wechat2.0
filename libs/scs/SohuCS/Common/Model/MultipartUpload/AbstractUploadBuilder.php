...
{
    /**
     * @var SohuCSClientInterface Client used to transfer requests
     */
    protected $client;
     ...
     *
     * @param SohuCSClientInterface $client Client to use
     *
     * @return self
     */
    public function setClient(SohuCSClientInterface $client)
    {
        $this->client = $client;
