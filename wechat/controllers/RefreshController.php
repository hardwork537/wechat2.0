<?php
	...
	class RefreshController extends BaseController{
		...
		public function indexAction(){
            ...
            $arrLog['logType'] = RealtorLog::LOGTYPE_FLUSH_COMMON;
            ...
            if($strUnitType == 'sale')
            {
                $columns ='House.id,House.bedRoom,House.livingRoom,House.bA,House.price,House.create,House.quality,House.timing,House.verification,sale.title,sale.refreshTime,sale.parkName,House.type as houseType';
            ...
            if($strUnitType == 'sale')
            {
                ...
                $maxRef = $arrorderport['saleRefresh'] - ($timeRef + $completeRef);
            }
            else
            {
            ...
            $this->display('refresh','index');
		}

        public function  mainAction(){
            $this->display('refresh','main');
        }
