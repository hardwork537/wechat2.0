...
class ServiceResponseException extends RuntimeException
{
    ...
    public function __toString()
    {
        $message = get_class($this) . ': '
            . 'SCS Error Code: ' . $this->getExceptionCode() . ', '
            . 'Status Code: ' . $this->getStatusCode() . ', '
            . 'SCS Request ID: ' . $this->getRequestId() . ', '
            . 'SCS Error Type: ' . $this->getExceptionType() . ', '
            . 'SCS Error Message: ' . $this->getMessage();
