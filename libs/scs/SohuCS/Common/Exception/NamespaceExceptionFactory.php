...
namespace SohuCS\Common\Exception;
...
class NamespaceExceptionFactory implements ExceptionFactoryInterface
{
    ...
    public function __construct(
        ...
        $baseNamespace,
        $defaultException = 'SohuCS\Common\Exception\ServiceResponseException'
    ) {
        $this->parser = $parser;
    ...
    public function fromResponse(RequestInterface $request, Response $response)
    {
        ...
        // Removing leading 'SCS.' and embedded periods
        $className = $this->baseNamespace . '\\' . str_replace(array('SCS.', '.'), '', $parts['code']);
