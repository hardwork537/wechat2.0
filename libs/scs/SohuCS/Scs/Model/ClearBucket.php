...
class ClearBucket extends AbstractHasDispatcher
{
    ...
    /**
     * @var SohuCSClientInterface Client used to execute the requests
     */
    protected $client;

    /**
     * @var AbstractScsResourceIterator Iterator used to yield keys
     */
    protected $iterator;
    ...
    /**
     * @param SohuCSClientInterface $client Client used to execute requests
     * @param string             $bucket Name of the bucket to clear
     */
    public function __construct(SohuCSClientInterface $client, $bucket)
    {
        $this->client = $client;
        $this->bucket = $bucket;
    }
